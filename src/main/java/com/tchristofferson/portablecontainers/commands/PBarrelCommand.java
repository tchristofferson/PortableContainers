...
public class PBarrelCommand implements CommandExecutor {

    private final PortableContainers plugin;

    public PBarrelCommand(PortableContainers plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        plugin.getPlayerContainers().get(player.getUniqueId()).openBarrel();
