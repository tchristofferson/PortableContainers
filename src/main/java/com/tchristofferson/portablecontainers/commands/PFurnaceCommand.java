...
public class PFurnaceCommand implements CommandExecutor {

    private final PortableContainers plugin;

    public PFurnaceCommand(PortableContainers plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        plugin.getPlayerContainers().get(player.getUniqueId()).openFurnace();
