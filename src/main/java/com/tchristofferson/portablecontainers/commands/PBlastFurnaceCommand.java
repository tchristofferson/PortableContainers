...
public class PBlastFurnaceCommand implements CommandExecutor {

    private final PortableContainers plugin;

    public PBlastFurnaceCommand(PortableContainers plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        plugin.getPlayerContainers().get(player.getUniqueId()).openBlastFurnace();
